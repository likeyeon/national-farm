  ...
  var t = {
      ...
      283: function (t, e, r) {
        ...
        var n = r(9504),
          ...
          w = (t.exports = function (t, e, r) {
            ...
            return (
              s(n, 'source') ||
                (n.source = b(g, 'string' == typeof e ? e : '')),
              t
            );
          });
      ...
      436: function (t, e, r) {
        ...
        var n,
          ...
          G = j.f,
          V = G,
          z = !!(U && U.createEvent && f.dispatchEvent),
          $ = 'unhandledrejection',
          K = function (t) {
            var e;
          ...
          X = function (t) {
            d(E, f, function () {
              ...
              if (
                Y(t) &&
                ((e = O(function () {
                  c ? H.emit('unhandledRejection', n, r) : J($, r, n);
                })),
        ...
        if (
          ...
          }).prototype = p(B, 'then', function (t, e) {
            var r = D(this),
              n = G(x(this, F));
            return (
              (r.parent = !0),
      ...
      647: function (t, e, r) {
        ...
        function n(t) {
          for (
            ...
            e[o].setAttribute('role', 'group');
            var i = (e[o].getAttribute('data-swiper-slide-index') || o % n) - 0;
            e[o].setAttribute('aria-label', ''.concat(i + 1, ' / ').concat(n));
          }
        }
        function o(t) {
          var e = Array.from(t.slides),
            r = e.length,
            n = t.slidesPerViewDynamic(),
            o = t.activeIndex;
          e.forEach(function (t) {
            return t.setAttribute('inert', '');
          });
          for (var i = Math.floor(n / 2), s = -i; s <= i; s++)
            e[(o + s + r) % r].removeAttribute('inert');
        }
        (r.d(e, {
          Dm: function () {
            return u;
          ...
          r(3500),
          r(3142));
        var i = new Swiper('.visual-swiper', {
            loop: !0,
            speed: 800,
      ...
      916: function (t, e, r) {
        ...
        t.exports = { CONSTRUCTOR: y, REJECTION_EVENT: v, SUBCLASSING: h };
      },
      1034: function (t, e, r) {
        'use strict';
        var n = r(9565),
        ...
        t.exports = s.correct
          ...
          : function (t) {
              return s.correct || !i(a, t) || o(t, 'flags') ? t.flags : n(u, t);
            };
      },
      1072: function (t, e, r) {
        'use strict';
      ...
      1088: function (t, e, r) {
        ...
        t.exports = function (t, e, r, s, h, y, A) {
          a(r, e, s);
          var T,
            L,
            I,
          ...
          if (
            ...
            if (((L = { values: j(S), keys: y ? D : j(E), entries: j(_) }), A))
              for (I in L) (w || R || !(I in k)) && p(k, I, L[I]);
            else n({ target: e, proto: !0, forced: w || R }, L);
          return (
            (i && !A) || k[x] === D || p(k, x, D, { name: h }),
            (v[e] = D),
            L
          );
        };
      ...
      1214: function (t, e, r) {
        ...
        (r(6099), r(3500));
        var n = r(647),
          o = document.querySelector('.banner-collect .banner-wrapper'),
          i = o.querySelectorAll('.play-button-wrapper button'),
          s = o.querySelectorAll('.play-button-wrapper .button-play'),
          u = o.querySelectorAll('.play-button-wrapper .button-pause'),
          a = o.querySelector('.swiper-wrapper'),
          c = !0;
        function f(t) {
          t
            ? (n.Dm.autoplay.start(),
        ...
        function l() {
          f(!n.Dm.autoplay.running);
        }
        (i.forEach(function (t) {
          t.addEventListener('click', l);
        }),
          n.Dm.el.addEventListener('focusin', function (t) {
            !n.Dm.el.contains(t.relatedTarget) &&
              (c = n.Dm.autoplay.running) &&
              f(!1);
          }),
          n.Dm.el.addEventListener('focusout', function (t) {
            !n.Dm.el.contains(t.relatedTarget) && c && f(!0);
          }));
      },
      1291: function (t, e, r) {
        'use strict';
      ...
      1828: function (t, e, r) {
        ...
        t.exports = function (t, e) {
          ...
          for (; e.length > c; ) o(n, (r = e[c++])) && (~s(f, r) || a(f, r));
          return f;
        };
      },
      1844: function () {
      ...
      1955: function (t, e, r) {
        ...
        if (!x) {
          var E = new d(),
            S = function () {
              var t, e;
              for (y && (t = g.domain) && t.exit(); (e = E.get()); )
                try {
                  e();
                } catch (t) {
                  throw (E.head && n(), t);
          ...
          (p || y || v || !b || !m
            ...
            : ((o = !0),
              (i = m.createTextNode('')),
              new b(S).observe(i, { characterData: !0 }),
              (n = function () {
                i.data = o = !o;
              })),
            (x = function (t) {
              ...
              'undefined' != typeof document
                ? document.domain && n
                  ...
                  : ((e = c('iframe')),
                    ...
                    t.F)
                : y(n);
            for (var o = s.length; o--; ) delete b[l][s[o]];
            return b();
          };
        ((u[p] = !0),
          (t.exports =
      ...
      2652: function (t, e, r) {
        ...
        t.exports = function (t, e, r) {
          var y,
            ...
            L = n(e, S),
            I = function (t) {
              return (y && d(y, 'normal'), new h(!0, t));
            },
            j = function (t) {
              return _
                ? (i(t), T ? L(t[0], t[1], I) : L(t[0], t[1]))
                : T
                  ? L(t, I)
                  : L(t);
            };
          if (O) y = t.iterator;
            ...
            if (!(b = l(t))) throw new p(s(t) + ' is not iterable');
            if (u(b)) {
              for (m = 0, g = a(t); g > m; m++)
          ...
          for (x = O ? t.next : y.next; !(E = o(x, y)).done; ) {
            try {
              w = j(E.value);
            } catch (t) {
              d(y, 'throw', t);
      ...
      3110: function (t, e, r) {
        ...
        v &&
          n(
            { target: 'JSON', stat: !0, arity: 3, forced: _ || O },
            {
              stringify: function (t, e, r) {
                var n = l(arguments),
                  o = i(_ ? A : v, null, n);
                return O && 'string' == typeof o ? g(o, x, T) : o;
              },
            }
          );
      },
        ...
        !(function () {
                      ...
                      value: function (t) {
                        if (t.nodeType === Node.ELEMENT_NODE) {
                          ...
                          (e !== this._rootElement &&
                            ...
                            (n.call(e, o) || e.hasAttribute('tabindex')) &&
                              this._manageNode(e));
                        }
                      },
                    },
                    ...
                    },
                    {
                      ...
                      value: function (t, e) {
                        t.forEach(function (t) {
                          var e = t.target;
                          if ('childList' === t.type)
                            (r.call(t.addedNodes).forEach(function (t) {
                              this._makeSubtreeUnfocusable(t);
                            }, this),
                              r.call(t.removedNodes).forEach(function (t) {
                            ...
                            if ('tabindex' === t.attributeName)
                              ...
                              this._adoptInertRoot(e);
                              var n = this._inertManager.getInertRoot(e);
                              this._managedNodes.forEach(function (t) {
                                e.contains(t.node) && n._manageNode(t.node);
                              });
                            }
                        }, this);
                      },
              ...
              u = (function () {
                function o(t) {
                  ...
                  ((this._document = t),
                    ...
                    f(t.head || t.body || t.documentElement),
                ...
                return (
                  t(o, [
                        ...
                        if (e) {
                          ...
                          if (
                            ...
                            for (var n = t.parentNode; n; )
                              (11 === n.nodeType && f(n), (n = n.parentNode));
                        } else {
                          if (!this._inertRoots.has(t)) return;
                    ...
                    },
                    {
                      key: 'register',
                      value: function (t, e) {
                        var r = this._managedNodes.get(t);
                        return (
                          void 0 !== r ? r.addInertRoot(e) : (r = new s(t, e)),
                          this._managedNodes.set(t, r),
                          r
                        );
                      },
                    },
                    {
                      ...
                      value: function (t, e) {
                        ...
                        return r
                          ? (r.removeInertRoot(e),
                            r.destroyed && this._managedNodes.delete(t),
                            r)
                          : null;
                      },
                    },
                        ...
                        t.forEach(function (t) {
                          switch (t.type) {
                            case 'childList':
                              r.call(t.addedNodes).forEach(function (t) {
                                if (t.nodeType === Node.ELEMENT_NODE) {
                                  var e = r.call(t.querySelectorAll('[inert]'));
                                  (n.call(t, '[inert]') && e.unshift(t),
                                    e.forEach(function (t) {
                                      this.setInert(t, !0);
                                    }, o));
                                }
          ...
          function c(t, e, r) {
            if (t.nodeType == Node.ELEMENT_NODE) {
              ...
              e && e(n);
              var o = n.shadowRoot;
              if (o) return void c(o, e, o);
              if ('content' == n.localName) {
                for (
                  var i = n,
                    s = i.getDistributedNodes ? i.getDistributedNodes() : [],
                    u = 0;
                  u < s.length;
                  u++
                )
              ...
              if ('slot' == n.localName) {
                for (
                  var a = n,
                    f = a.assignedNodes ? a.assignedNodes({ flatten: !0 }) : [],
                    l = 0;
                  l < f.length;
                  l++
                )
            ...
            for (var d = t.firstChild; null != d; )
              (c(d, e, r), (d = d.nextSibling));
          }
          function f(t) {
      ...
      3230: function (t, e, r) {
        'use strict';
        (r(6099), r(3500));
        var n = document.querySelectorAll('.drawer .depth1'),
          o = document.querySelectorAll('.drawer .depth2-item');
        (n.forEach(function (t) {
          (t
            .querySelector('.depth1-title')
          ...
          o.forEach(function (t) {
            var e = t.querySelector('.depth3-title');
            (e.addEventListener('click', function (t) {
              t.preventDefault();
            }),
              e.addEventListener('click', function () {
                !(function (t) {
                  var e = t.querySelector('.depth3'),
                    r = e.querySelector('.depth3-list').scrollHeight;
                  (t.classList.toggle('is-active'),
                    (e.style.maxHeight = t.classList.contains('is-active')
                      ? r + 'px'
                      : 0),
                    t.classList.contains('is-active')
                      ? ((e.style.maxHeight = r + 'px'),
                        e.removeAttribute('inert'))
                      : ((e.style.maxHeight = 0), e.setAttribute('inert', '')));
                })(t);
              }));
          }));
      },
      ...
      4758: function (t, e, r) {
        ...
        (r(6099), r(3500));
        var n = r(6881),
          o = document.querySelectorAll('.news .news-tab-item'),
          i = document.querySelectorAll('.news .news-board-list'),
          s = o.length,
          u = document.querySelector('.news .news-tab-more a');
              ...
              switch (t.keyCode) {
                case n.DK:
                  t.shiftKey
                    ...
                    : (document
                        .querySelector('.news-board-list.is-active a')
                        .focus(),
                      t.preventDefault());
                  break;
                case n._x:
                  e < s - 1 ? o[e + 1].focus() : e === s - 1 && o[0].focus();
                  break;
                case n.Lb:
                  e > 0 ? o[e - 1].focus() : 0 === e && o[s - 1].focus();
                  break;
                case n.f7:
                  (t.preventDefault(), o[s - 1].focus());
                  break;
                case n.NH:
      ...
      4776: function (t, e, r) {
        'use strict';
        var n = r(647),
          o = document.querySelector('.visual-banner'),
          i = o.querySelector('.swiper-wrapper'),
          s = o.querySelector('.play-button-wrapper'),
          u = s.querySelector('.swiper-button-play'),
          a = s.querySelector('.swiper-button-pause'),
          c = !0;
        function f(t) {
          t
            ? (n.ZI.autoplay.start(),
        ...
        (s.addEventListener('click', function () {
          f(!n.ZI.autoplay.running);
        }),
          n.ZI.el.addEventListener('focusin', function () {
            (c = n.ZI.autoplay.running) && f(!1);
          }),
          n.ZI.el.addEventListener('focusout', function (t) {
            !n.ZI.el.contains(t.relatedTarget) && c && f(!0);
          }));
      },
      4782: function (t, e, r) {
        'use strict';
          ...
          { target: 'Array', proto: !0, forced: !h },
          {
            slice: function (t, e) {
              ...
              if (
                ...
                return p(d, m, g);
              for (
                n = new (void 0 === r ? y : r)(b(g - m, 0)), l = 0;
                m < g;
                m++, l++
              )
                m in d && f(n, l, d[m]);
      ...
      5560: function (t, e, r) {
        ...
        (r(6099), r(3500));
        var n = r(6881),
          o = document.querySelectorAll('.gnb .depth1'),
          i = document.querySelectorAll('.gnb .depth1-title'),
          s = i.length;
        (o.forEach(function (t) {
          (t.addEventListener('mouseover', function () {
            ...
            t.addEventListener('focusout', function (e) {
              t.contains(e.relatedTarget) || t.classList.remove('over');
            }));
        }),
          i.forEach(function (t, e) {
            t.addEventListener('keydown', function (r) {
              switch (r.keyCode) {
                case n._x:
                  (t.classList.remove('over'),
                    e < s - 1 ? i[e + 1].focus() : e === s - 1 && i[0].focus());
                  break;
                case n.Lb:
                  (t.classList.remove('over'),
                    e > 0 ? i[e - 1].focus() : 0 === e && i[s - 1].focus());
                  break;
                case n.f7:
                  (r.preventDefault(),
                    t.classList.remove('over'),
      ...
      5614: function () {
        var t = document.querySelector('.drawer'),
          ...
          r = t.querySelector('.close'),
          n = document.querySelector('.header-main .drawer-button > button'),
          o = t.querySelector('.home > a');
        function i(r) {
          t.contains(r.target) ||
            n.contains(r.target) ||
            (t.classList.remove('is-active'),
      ...
      6419: function (t, e, r) {
        'use strict';
        (r(6099), r(3500));
        var n = document.querySelector('.global-header .agency-select'),
          o = n.querySelector('.agency-listbox'),
          i = o.querySelectorAll('li'),
          s = n.querySelector('.agency-selected');
        function u(t) {
          (n.contains(t.target) && 27 !== t.keyCode) ||
        ...
        (s.addEventListener('click', a),
          i.forEach(function (t) {
            t.addEventListener('click', function () {
              ((s.textContent = t.getAttribute('data-value')),
                a(),
                t.dataset.href && (location.href = t.dataset.href));
            });
          }));
      },
      6469: function (t, e, r) {
      ...
      6518: function (t, e, r) {
        ...
        t.exports = function (t, e) {
          var r,
            ...
            v = t.global,
            y = t.stat;
          if ((r = v ? n : y ? n[h] || u(h, {}) : n[h] && n[h].prototype))
            for (f in e) {
              if (
                ((d = e[f]),
                (l = t.dontCallGetSet ? (p = o(r, f)) && p.value : r[f]),
                !c(v ? f : h + (y ? '.' : '#') + f, t.forced) && void 0 !== l)
              ) {
                if (typeof d == typeof l) continue;
                a(d, l);
              }
              ((t.sham || (l && l.sham)) && i(d, 'sham', !0), s(r, f, d, t));
            }
        };
      },
      6699: function (t, e, r) {
      ...
      6761: function (t, e, r) {
        ...
        var n = r(6518),
            ...
            return (
              ...
              l(rt, n)
                ? (r.enumerable
                    ...
                    : (l(t, q) || Y(t, q, b(1, m(null))), (t[q][n] = !0)),
                  ut(t, n, r))
                : Y(t, n, r)
            );
          },
          ...
          lt = function (t) {
            ...
            return (
              ...
              (!(r || !l(this, e) || !l(rt, e) || (l(this, q) && this[q][e])) ||
                r)
            );
          },
          dt = function (t, e) {
            ...
            if (r !== z || !l(rt, n) || l(nt, n)) {
              var o = X(r, n);
              return (
                !o || !l(rt, n) || (l(r, q) && r[q][n]) || (o.enumerable = !0),
                o
              );
            }
          },
        ...
        (c ||
          (($ = function () {
            if (d(K, this)) throw new Z('Symbol is not a constructor');
            var t =
            ...
            return (
              a && it && ut(z, e, { configurable: !0, set: r }),
              at(e, t)
            );
          }),
          ...
          a &&
            ...
            u || T(z, 'propertyIsEnumerable', lt, { unsafe: !0 }))),
          n(
      ...
      6801: function (t, e, r) {
        ...
        e.f =
          n && !o
            ...
            : function (t, e) {
                s(t);
                for (var r, n = u(e), o = a(e), c = o.length, f = 0; c > f; )
                  i.f(t, (r = o[f++]), n[r]);
                return t;
              };
      },
        ...
        ((E || _ || S || p || h) &&
          (b = function (t) {
            ...
            if (
              ...
              for (o.groups = c = l(null), s = 0; s < T.length; s++)
                c[(f = T[s])[0]] = o[f[1]];
            return o;
          }),
          (t.exports = b));
      ...
      7740: function (t, e, r) {
        ...
        var n = r(9297),
          ...
          s = r(4913);
        t.exports = function (t, e, r) {
          for (var u = o(e), a = s.f, c = i.f, f = 0; f < u.length; f++) {
            var l = u[f];
            n(t, l) || (r && n(r, l)) || a(t, l, c(e, l));
          }
        };
      },
      7743: function (t, e, r) {
      ...
      7916: function (t, e, r) {
        ...
        t.exports = function (t) {
          ...
          var b,
            ...
            _ = 0;
          if (!S || (this === p && u(S)))
            for (b = c(e), m = r ? new this(b) : p(b); b > _; _++)
              ((E = y ? v(e[_], _) : e[_]), f(m, _, E));
          else
            for (
              m = r ? new this() : [], x = (w = l(e, S)).next;
              !(g = o(x, w)).done;
              _++
            )
              ((E = y ? s(w, v, [g.value, _], !0) : g.value), f(m, _, E));
          return ((m.length = _), m);
        };
      },
      7979: function (t, e, r) {
      ...
      8154: function (t, e, r) {
        ...
        var n = r(647),
          ...
          i = n.Fc.el.querySelector('.swiper-wrapper'),
          s = o.querySelector('.play-button-wrapper'),
          u = s.querySelector('.swiper-button-play'),
          a = s.querySelector('.swiper-button-pause'),
          c = !0;
        ...
        (s.addEventListener('click', function () {
          f(!n.Fc.autoplay.running);
        }),
          n.Fc.el.addEventListener('focusin', function () {
            (c = n.Fc.autoplay.running) && f(!1);
          }),
          n.Fc.el.addEventListener('focusout', function (t) {
            !n.Fc.el.contains(t.relatedTarget) && c && f(!0);
          }));
      },
      8183: function (t, e, r) {
        'use strict';
      ...
      8977: function (t, e, r) {
          ...
          return (
            ...
            (this.text = function () {
              ...
              if (this._bodyBlob)
                return (
                  (t = this._bodyBlob),
                  (r = b((e = new FileReader()))),
                  (o = (n = /charset=([A-Za-z0-9_-]+)/.exec(t.type))
                    ? n[1]
                    : 'utf-8'),
                  e.readAsText(t, o),
                  r
        ...
        ((v.prototype.append = function (t, e) {
          ...
          s && (v.prototype[Symbol.iterator] = v.prototype.entries));
        var x = [
          'CONNECT',
          'DELETE',
          'GET',
          ...
          return new Promise(function (r, n) {
            ...
            if (
              ...
              e &&
                ...
                !(
                  e.headers instanceof v ||
                  (o.Headers && e.headers instanceof o.Headers)
                ))
            ) {
              var f = [];
              (Object.getOwnPropertyNames(e.headers).forEach(function (t) {
                (f.push(d(t)), s.setRequestHeader(t, p(e.headers[t])));
              }),
                i.headers.forEach(function (t, e) {
                  -1 === f.indexOf(e) && s.setRequestHeader(e, t);
                }));
            } else
              i.headers.forEach(function (t, e) {
        ...
        ((L.polyfill = !0),
          o.fetch ||
            ...
            (o.Request = E),
            (o.Response = _)));
        var j = document.querySelectorAll('.news .news-board-list');
        fetch('../data/news-data.json')
          .then(function (t) {
            if (!t.ok) throw new Error('HTTP 오류! 상태: '.concat(t.status));
            return t.json();
          })
          .then(function (t) {
            ((A = t),
              ...
              j.forEach(function (t) {
                t.querySelectorAll('.news-board-item')[0].addEventListener(
                  'keydown',
                  function (t) {
                    t.shiftKey &&
                      t.keyCode === n.DK &&
                      (document
                        .querySelector('.news .news-tab-item.is-active')
                        .focus(),
                      t.preventDefault());
                  }
                );
            ...
            return function (h, v, y, b) {
              for (
                var m,
                  ...
                  _ = 0,
                  O = b || a,
                  A = e ? O(h, E) : r || d ? O(h, 0) : void 0;
                E > _;
                _++
              )
                if ((p || _ in x) && ((g = S((m = x[_]), _, w)), t))
                  if (e) A[_] = g;
                  else if (g)
                    switch (t) {
                      case 3:
            ...
            : E && E.now
              ...
              : _ && !b
                ...
                : u.addEventListener &&
                    ...
                    'file:' !== n.protocol &&
                    !d(R)
                  ? ((o = R), u.addEventListener('message', N, !1))
                  : (o =
                      L in v('script')
                        ? function (t) {
                            p.appendChild(v('script'))[L] = function () {
